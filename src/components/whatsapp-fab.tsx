...
export default function WhatsAppFAB() {
    ...
    if (!whatsappLink || whatsappLink === 'https://chat.whatsapp.com/your-invite-code-here') {
        // Don't render the button if the link is not configured or is the default placeholder
        return null;
    }
        ...
        <TooltipProvider>
            <Tooltip>
                ...
                <TooltipContent side="left">
                    <p>Ask a question on WhatsApp</p>
                </TooltipContent>
            </Tooltip>
        </TooltipProvider>
    );
